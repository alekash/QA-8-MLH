...
describe('Labels are Correct', function () {
    ...
    it('TC-018 Gender field label = "2. Please choose gender."', function () {
        let genderLabel = $$(sel.requiredLabels)[1].getText();
  ...
  /*
    it('TC-022 Age field label  = "3. How old is your hero?"', function () {
        let ageLabel = $$(sel.requiredLabels)[2].getText();
        expect(ageLabel).toEqual(exp.ageLabel);
    });
*/
    it('TC-023 Type of story label = "4. What type of story would you like to read?"', function () {
        let storyTypeLabel = $$(sel.requiredLabels)[3].getText();
        expect(storyTypeLabel).toEqual(exp.storyLabel);
    });
